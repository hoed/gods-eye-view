...
1. Copy `.env.example` → `.env` (no map API key is required).
2. Install and run:
...
The default map is OpenStreetMap and runs without an API key. Optional providers and enrichments are listed in [Keys & Costs](#-api-keys).
