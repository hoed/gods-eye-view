 ...
 * Initializes CesiumJS with a keyless OpenStreetMap globe,
...
async function init() {
  ...
  try {
    ...
    // Create the Cesium viewer with minimal chrome. The default globe uses
    // public OpenStreetMap tiles and does not require a provider key.
    ...
    // Keep the globe atmosphere readable over the keyless OSM imagery.
    viewer.scene.skyAtmosphere.show = true;
    viewer.scene.skyAtmosphere.atmosphereLightIntensity = 18;
    viewer.scene.skyAtmosphere.saturationShift = -0.12;
    viewer.scene.skyAtmosphere.brightnessShift = -0.08;

    loaderStatus.textContent = 'Loading OpenStreetMap...';
    let tileset = null;
